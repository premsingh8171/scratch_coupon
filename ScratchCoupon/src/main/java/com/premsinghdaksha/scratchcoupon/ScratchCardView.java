package com.premsinghdaksha.scratchcoupon;
...
import com.premsinghdaksha.scratchcoupon.helpers.UnitHelper;

public class ScratchCardView extends View {

    public interface OnScratchListener {
        public void onScratch(ScratchCardView scratchCardView, float visiblePercent);
    }
    ...
    private void resolveAttr(Context context, AttributeSet attrs) {
        ...
        mScratchWidth = a.getDimension(R.styleable.ScratchCard_scratchWidth, UnitHelper.dipToPx(context, 30));
        a.recycle();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mDrawable != null) {
            ...
            mDrawable.setBounds(-2, -4, mBitmap.getWidth(), mBitmap.getHeight());
